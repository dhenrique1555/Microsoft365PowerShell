...
$ObjectPrincipalID = read-host "Insert ObjectID for Enterprise App"
...
$permissions = "User.ReadWrite.All","Directory.ReadWrite.All" #Example: "Directory.Read.All", "Device.Read.All" find all at: https://learn.microsoft.com/en-us/graph/permissions-reference
